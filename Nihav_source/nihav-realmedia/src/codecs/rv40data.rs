use super::rv3040::MBType;

pub const RV40_QUANT_DC: [[u8; 32]; 2] = [
  [
...
pub const RV40_AIC_PATTERNS: [u16; 20] = [
    0x000, 0x100, 0x200,
...
pub const RV40_AIC_TOP_CODES: [u8; 16] = [
    0x01, 0x05, 0x01, 0x00, 0x03, 0x3D, 0x1D, 0x02,
    0x04, 0x3C, 0x3F, 0x1C, 0x0D, 0x3E, 0x0C, 0x01
];
pub const RV40_AIC_TOP_BITS: [u8; 16] = [
    1, 4, 5, 5, 5, 7, 6, 5, 4, 7, 7, 6, 5, 7, 5, 3
];

pub const RV40_AIC_MODE1_CODES_DUMMY: [u8; 1] = [ 0 ];
pub const RV40_AIC_MODE1_BITS_DUMMY: [u8; 1] = [ 1 ];

pub const RV40_AIC_MODE1_CODES: [[u8; 9]; 90] = [
...
pub static RV40_AIC_MODE1_BITS: [[u8; 9]; 90] = [
  [  1,  4,  2,  7,  4,  6,  4,  7,  5 ],
  [  5,  1,  3,  4,  6,  3,  3,  7,  7 ],
  [  1,  4,  2,  7,  6,  7,  5,  4,  4 ],
  [  1,  3,  3,  3,  7,  4,  5,  7,  6 ],
...
pub const RV40_AIC_MODE2_CODES: [[u16; 81]; 20] = [
  [
...
pub const RV40_AIC_MODE2_BITS: [[u8; 81]; 20] = [
  [
1,  5,  4, 10,  6,  8,  5,  8,  8,
...
pub const RV40_PTYPE_CODES: &[[u8; 8]; 7] = &[
...
pub const RV40_PTYPE_BITS: &[[u8; 8]; 7] = &[
  [ 1, 2, 3, 6, 5, 4, 7, 7 ],
  [ 3, 1, 2, 7, 6, 5, 4, 7 ],
  [ 5, 4, 1, 4, 3, 3, 4, 5 ],
  [ 4, 5, 2, 2, 3, 2, 6, 6 ],
...
pub const RV40_PTYPE_SYMS: &[MBType; 8] = &[
    MBType::MBIntra,
    MBType::MBIntra16,
    MBType::MBP16x16,
    MBType::MBP8x8,
...
pub const RV40_BTYPE_CODES: &[[u8; 7]; 6] = &[
...
pub const RV40_BTYPE_BITS: &[[u8; 7]; 6] = &[
  [ 2, 3, 2, 2, 5, 4, 5 ],
  [ 4, 1, 3, 2, 6, 5, 6 ],
  [ 6, 4, 1, 2, 5, 3, 6 ],
  [ 5, 3, 3, 1, 4, 3, 5 ],
...
pub const RV40_BTYPE_SYMS: &[MBType; 7] = &[
    MBType::MBIntra,
    MBType::MBIntra16,
    MBType::MBForward,
    MBType::MBBackward,
