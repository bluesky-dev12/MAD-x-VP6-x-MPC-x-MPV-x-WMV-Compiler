...
pub struct QuantMats {
    pub intra_qmat: [[i32; 64]; 16],
    pub inter_qmat: [[i32; 64]; 16],
}

impl QuantMats {
    pub fn calc_binkb_quants(&mut self) {
...
pub const BINKB_RUN_BITS: [u8; 64] = [
    6, 6, 6, 6, 6, 6, 6, 6,
    6, 6, 6, 6, 6, 6, 6, 6,
    6, 6, 6, 6, 6, 6, 6, 6,
    6, 6, 6, 6, 6, 6, 6, 6,
...
pub const BINKB_REF_INTRA_Q: [u8; 64] = [
...
pub const BINKB_REF_INTER_Q: [u8; 64] = [
...
pub const BINKB_REF_QUANTS: [(u8, u8); 16] = [
